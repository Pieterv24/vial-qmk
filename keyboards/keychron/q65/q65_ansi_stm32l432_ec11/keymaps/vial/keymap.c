...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [MAC_ALT] =     { ENCODER_CCW_CW(_______, _______)  },
    [WIN_ALT] =     { ENCODER_CCW_CW(_______, _______)  },
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_73(
        ...
        MACRO03,     KC_LCTL,  KC_LOPTN, KC_LCMMD,                            KC_SPC,                             KC_RCMMD, MO(MAC_ALT),MO(_FN),KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_73(
        ...
        MACRO01,     KC_CAPS,  KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,            KC_ENT,           KC_PGDN,
        MACRO02,     KC_LSFT,            KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,   KC_END,
        MACRO03,     KC_LCTL,  KC_LGUI,  KC_LALT,                             KC_SPC,                             KC_RALT,  MO(WIN_ALT),MO(_FN),KC_LEFT, KC_DOWN, KC_RGHT),

    [MAC_ALT] = LAYOUT_ansi_73(
    ...
    [_FN] = LAYOUT_ansi_73(
        _______,    KC_TILD, KC_F1,     KC_F2,     KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_DEL ,          _______,
        _______,    RGB_TOG, RGB_MOD,   RGB_VAI,   RGB_HUI, RGB_SAI, RGB_SPI, _______, _______, _______, _______, _______,  _______,  _______,  _______,          _______,
        _______,    _______, RGB_RMOD,  RGB_VAD,   RGB_HUD, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______,  _______,            _______,          _______,
