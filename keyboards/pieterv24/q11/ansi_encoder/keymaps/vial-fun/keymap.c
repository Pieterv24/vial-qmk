...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        MC_5,  KC_LCTL,  KC_LWIN,  KC_LALT,  MO(_FN1),           KC_SPC,                        KC_SPC,             KC_RALT,  MO(_FN1),   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_FN3]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI), ENCODER_CCW_CW(RGB_VAD, RGB_VAI)}
};
